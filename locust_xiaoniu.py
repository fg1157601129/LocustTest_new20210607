...
class gZhaoyuLogin(TaskSet):
    ...
    def login_user(self):
        ...
        # base_data
        self.request_id = get_timestamp_micros()
        self.request_agent = "1"
        self.device_id = get_timestamp_micros()
        self.os_version = "0"
        self.phone_model = "iPhone15"
        self.version_1 = "v1.0"
